...
namespace Mesh
{
    ...
    class Package : public cgScriptPackage
    {
        ...
        void bind( cgScriptEngine * engine )
        {
            ...
            // ToDo: bool createBox           ( cgVertexFormat * format, cgFloat width, cgFloat height, cgFloat depth, cgUInt32 widthSegments, cgUInt32 heightSegments, cgUInt32 depthSegments, cgFloat texUScale, cgFloat texVScale, bool inverted, cgMeshCreateOrigin::Base origin, bool hardwareCopy = true, cgResourceManager * resourceManager = NULL );
