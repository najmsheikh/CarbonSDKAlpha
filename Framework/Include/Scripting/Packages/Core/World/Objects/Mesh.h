...
namespace Mesh
{
    ...
    void registerNodeMethods( cgScriptEngine * engine, const cgChar * typeName )
    {
        ...
        BINDSUCCESS( engine->registerObjectMethod( typeName, "bool createBox( float, float, float, uint, uint, uint, float, float, bool, MeshCreateOrigin )", asMETHODPR(type,createBox, ( cgFloat, cgFloat, cgFloat, cgUInt32, cgUInt32, cgUInt32, cgFloat, cgFloat, bool, cgMeshCreateOrigin::Base ), bool ), asCALL_THISCALL) );
