...
namespace DepthOfFieldProcessor
{
    ...
    class Package : public cgScriptPackage
    {
        ...
        void bind( cgScriptEngine * engine )
        {
            ...
            BINDSUCCESS( engine->registerObjectMethod( "DepthOfFieldProcessor", "void setBackgroundBlur( const BlurOpDesc &in, const BlurOpDesc &in )", asMETHODPR(cgDepthOfFieldProcessor, setBackgroundBlur, (const cgBlurOpDesc &, const cgBlurOpDesc &), void), asCALL_THISCALL) );
            BINDSUCCESS( engine->registerObjectMethod( "DepthOfFieldProcessor", "void setForegroundBlur( const BlurOpDesc &in, const BlurOpDesc &in )", asMETHODPR(cgDepthOfFieldProcessor, setForegroundBlur, (const cgBlurOpDesc &, const cgBlurOpDesc &), void), asCALL_THISCALL) );
