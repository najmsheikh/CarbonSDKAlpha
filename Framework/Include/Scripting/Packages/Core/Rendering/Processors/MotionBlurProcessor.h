...
namespace MotionBlurProcessor
{
    ...
    class Package : public cgScriptPackage
    {
        ...
        void bind( cgScriptEngine * engine )
        {
			...
			BINDSUCCESS( engine->registerObjectMethod( "MotionBlurProcessor", "void setCompositeSpeedScale( float )", asMETHODPR(cgMotionBlurProcessor, setCompositeSpeedScale, (cgFloat), void), asCALL_THISCALL) );
