...
// Common Containers
CGE_ARRAY_DECLARE           ( cgByte, cgByteArray )
CGE_ARRAY_DECLARE           ( cgInt8, cgInt8Array )
CGE_ARRAY_DECLARE           ( cgInt16, cgInt16Array )
CGE_ARRAY_DECLARE           ( cgUInt16, cgUInt16Array )
CGE_ARRAY_DECLARE           ( cgInt32, cgInt32Array )
CGE_UNORDEREDSET_DECLARE    ( cgInt32, cgInt32Set )
CGE_ARRAY_DECLARE           ( cgUInt32, cgUInt32Array )
CGE_UNORDEREDSET_DECLARE    ( cgUInt32, cgUInt32Set )
CGE_UNORDEREDMAP_DECLARE    ( cgUInt32, cgUInt32, cgUInt32IndexMap )
CGE_ARRAY_DECLARE           ( cgInt, cgIntArray )
CGE_ARRAY_DECLARE           ( cgFloat, cgFloatArray )
CGE_ARRAY_DECLARE           ( cgDouble, cgDoubleArray )
CGE_ARRAY_DECLARE           ( cgPoint, cgPointArray )
CGE_ARRAY_DECLARE           ( cgRect, cgRectArray )
CGE_ARRAY_DECLARE           ( cgString, cgStringArray )
CGE_UNORDEREDSET_DECLARE    ( cgString, cgStringSet )
CGE_ARRAY_DECLARE           ( cgUID, cgUIDArray )
CGE_LIST_DECLARE            ( cgWorldObject*, cgWorldObjectList )
CGE_UNORDEREDSET_DECLARE    ( cgWorldObject*, cgWorldObjectSet )
CGE_ARRAY_DECLARE           ( cgWorldObject*, cgWorldObjectArray )
...
CGE_ARRAY_DECLARE           ( cgObjectNode*, cgObjectNodeArray )
CGE_MAP_DECLARE             ( cgUInt32, cgObjectSubElement*, cgObjectSubElementMap )
CGE_ARRAY_DECLARE           ( cgObjectSubElement*, cgObjectSubElementArray )
CGE_MAP_DECLARE             ( cgUInt32, cgSceneElement*, cgSceneElementMap )
CGE_ARRAY_DECLARE           ( cgSceneElement*, cgSceneElementArray )
CGE_ARRAY_DECLARE           ( cgSpatialTreeLeaf*, cgSceneLeafArray )
