...
public:
	...
	virtual void *GetUserData(asPWORD type) const = 0;
...
public:
    ...
    virtual int              GetSubTypeToken(asUINT subtypeIndex = 0) const = 0; // AMH: Added to support primitive array type detection
