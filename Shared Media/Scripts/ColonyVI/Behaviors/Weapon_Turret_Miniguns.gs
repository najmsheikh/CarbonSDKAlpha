...
//---------------------------------------------------------------------------//
//                                                                           //
// Name : Weapon_Turret_Miniguns.gs                                          //
//                                                                           //
// Desc : Behavior script associated with the enemy turret's built in        //
//        miniguns.                                                          //
//                                                                           //
//---------------------------------------------------------------------------//
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
// Name : Weapon_Turret_Miniguns (Class)
// Desc : Behavior script associated with the enemy turret's built in miniguns.
//-----------------------------------------------------------------------------
shared class Weapon_Turret_Miniguns : Weapon
{
    ///////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////
    //-------------------------------------------------------------------------
	// Name : Weapon_Turret_Miniguns () (Constructor)
	// Desc : Custom constructor for this class.
	//-------------------------------------------------------------------------
	Weapon_Turret_Miniguns( )
    {
        // Describe the weapon
        mRepeatCycle            = 0.05f; // 50ms
        mRoundsPerMagazine      = 999999999;
        mRoundsPerBurst         = 20;
	...
	void onAttach( ObjectNode @ object )
	{
        ...
        @mMuzzleFlashEmitters[0] = cast<ParticleEmitterNode>(object.findChild( "Muzzle_Flash_Turret_Minigun_01" ));
        @mMuzzleFlashEmitters[1] = cast<ParticleEmitterNode>(object.findChild( "Muzzle_Flash_Turret_Minigun_02" ));
    ...
    WeaponFiringMode cycleFiringMode( )
    {
        ...
        return WeaponFiringMode::FullyAutomatic;
    }

} // End Class Weapon_Turret_Miniguns