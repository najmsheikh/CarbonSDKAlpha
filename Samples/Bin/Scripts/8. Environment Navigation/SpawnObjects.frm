...
shared class SpawnObjects : IScriptedForm
{
    ...
    private CameraNode@     mPlayerCamera;
    ...
    //-------------------------------------------------------------------------
    // Name : setPlayerCamera()
    // Desc : Called by the application to set the camera that represents the
    //        player.
    //-------------------------------------------------------------------------
    void setPlayerCamera( CameraNode @ camera )
    {
        // Store the camera handle for later use.
    ...
    private void spawnObject( uint referenceId )
    {
        ...
        node.setPosition( mPlayerCamera.getPosition() + mPlayerCamera.getZAxis() * 3.0f );
    }
